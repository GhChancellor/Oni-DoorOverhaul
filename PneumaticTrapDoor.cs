...
{
    public class PneumaticTrapDoor : IBuildingConfig
    {
        private static string buildingId = "PneumaticTrapDoor";
        ...
        private BuildLocationRule buildLocationRule_ = BuildLocationRule.Tile;
        ...
        public PneumaticTrapDoor():base(){
            var Construction = Create();
        ...
        public override BuildingDef CreateBuildingDef()
        {
            BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(
                ...
                build_location_rule: buildLocationRule_,
                decor: decor,
                noise: noise,
        ...
        private (float[] constructionMass, float constructionTime) Create()
        {
